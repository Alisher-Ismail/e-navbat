...
class QidiruvController extends Controller
{
    public function qidiruv()
    {
        ...
        return view('client.qidiruv', compact('qidiruv', 'vaqt'));
    }

    public function navbatkorish()
    {
        // Return the view with the fetched data
        return view('client.navbatkorish');
    }
    ...
    public function navbat(Request $request)
    {
        ...
        return view('client.navbat', compact('uid', 'user'));
    }
    ...
    public function navbattekshirish(Request $request)
    {
        ...
        $user = User::all();
        // Now you can use the $vaqt value
        return view('client.navbattekshirish', compact('navbat', 'user'));
    }
