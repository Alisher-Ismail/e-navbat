...
class QidiruvControllerRu extends Controller
{
    public function qidiruv()
    {
        ...
        return view('clientru.qidiruv', compact('qidiruv', 'vaqt'));
    }

    public function navbatkorish()
    {
        // Return the view with the fetched data
        return view('clientru.navbatkorish');
    }
    ...
    public function navbat(Request $request)
    {
        ...
        return view('clientru.navbat', compact('uid', 'user'));
    }
    ...
    public function navbattekshirish(Request $request)
    {
        ...
        $user = User::all();
        // Now you can use the $vaqt value
        return view('clientru.navbattekshirish', compact('navbat', 'user'));
    }
    ...
    public function navbatbekor(Request $request)
    {
        ...
        $navbat->delete();
        // Now you can use the $vaqt value
        return redirect()->back()->with('success', 'Отменено');
    }
    ///navbat store
