...
class VaqtController extends Controller
{   
    //navbat
    function navbattasdiq(){
        ...
        return view('admin.navbattasdiqlangan', compact('vaqt'));
    }
    ...
    function navbatxizmat(){
        ...
        return view('admin.navbatxizmat', compact('vaqt'));
    }
        ...
        return view('admin.navbat', compact('vaqt'));
    }
    ...
    public function tasdiqlash(Request $request)
    {
        ...
        try {
            ...
            return response()->json('Tasdiqlandi.');
        } catch (\Exception $e) {
    ...
    public function xizmat(Request $request)
    {
        ...
        try {
            ...
            // If you want to return a response message, you can do so
            return response()->json('Xizmat ko`rsatildi.');
        } catch (\Exception $e) {
            return response()->json($e->getMessage(), 500); // Handle any errors
        }
    }
    ...
    function vaqt(){
        ...
        return view('admin.vaqt', compact('vaqt'));
    }
