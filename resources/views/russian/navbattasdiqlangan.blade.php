    ...
    if (selectedIds.length === 0) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $('#suss_message').fadeIn().delay(1200).fadeOut();
                setTimeout(function() {
                    window.location.href = "{{ route('adminnavbattasdiqru') }}";
                }, 4000);
            },
            error: function(xhr, status, error) {
                // Handle error
...
<!-- /.form-group -->
    ...
    <div class="card-header">
        <h3 class="card-title">Подтвержденные записи на прием и предоставление услуг</h3>
    </div>
    ...
    <button style="float: left; margin-right: 1%; width: 200px;" type="button" id="submit1" class="btn btn-primary" onclick="xizmatSelectedItems()">Услуга предоставлена</button>
