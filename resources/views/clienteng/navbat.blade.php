    ...
    @if($errors->any())
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Appointment (Expert: {{ $user->name }}  )</h3>
              </div>
              <div class="card-body">
                <!-- Date dd/mm/yyyy -->
          ...
          <div class="col-md-6">
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Confirm: When click on appoint time, it will be sent to database</h3>
              </div>
              <div class="card-body">
                <!-- Date -->
                ...
                success: function(data) {
                    ...
                    if (data.vaqt && data.vaqt.length > 0) {
                        ...
                        data.vaqt.forEach(function(vaqt) {
                            var link = $('<a>', {
                                text: vaqt,
                                href: `/navbatstoreeng/?userid=${userId}&sana=${sana}&vaqt=${vaqt}&ism=${ism}&tel=${tel}&maqsad=${maqsad}`,  // Construct the URL with parameters
                        ...
                        $('#vaqt-links').append('<p>Not Found</p>');
                    }
                },
                error: function(xhr) {
