    ...
    @if($errors->any())
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Qabulga Yozilish (Mutaxassis: {{ $user->name }}  )</h3>
              </div>
              <div class="card-body">
                <!-- Date dd/mm/yyyy -->
                ...
                <div class="form-group">
                  <label>Qabulga Yozilishdan Maqsad:</label>
                    <div class="input-group">
          ...
          <div class="col-md-6">
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Tasdiqlash: Qabul Vaqtini Tanlasangiz ma'lumotingiz bazaga yuboriladi</h3>
              </div>
              <div class="card-body">
                <!-- Date -->
    ...
    $('#sana').on('change', function() {
        ...
        if (sana && userId && ism && tel && maqsad) {
          if(sana >= formattedToday){
                ...
                success: function(data) {
                    ...
                    if (data.vaqt && data.vaqt.length > 0) {
                        ...
                        data.vaqt.forEach(function(vaqt) {
                            var link = $('<a>', {
                                text: vaqt,
                                href: `/navbatstore/?userid=${userId}&sana=${sana}&vaqt=${vaqt}&ism=${ism}&tel=${tel}&maqsad=${maqsad}`,  // Construct the URL with parameters
                        ...
                        $('#vaqt-links').append('<p>Ma\'lumot Topilmadi</p>');
                    }
                },
                error: function(xhr) {
            ...
            alert("Sana bugun yoki kelajadagi sana bo`lishi shart");
