    ...
    if (selectedIds.length === 0) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $('#suss_message').fadeIn().delay(1200).fadeOut();
                setTimeout(function() {
                    window.location.href = "{{ route('adminnavbat') }}";
                }, 4000);
            },
            error: function(xhr, status, error) {
                // Handle error
...
<!-- /.form-group -->
    ...
    <div class="card-header">
        <h3 class="card-title">Qabulga Yozilganlarni Ko`rish va Tasdiqlash</h3>
    </div>
    ...
    <button style="float: left; margin-right: 1%; width: 200px;" type="button" id="submit1" class="btn btn-success" onclick="tasdiqSelectedItems()">Tasdiqlash</button>
