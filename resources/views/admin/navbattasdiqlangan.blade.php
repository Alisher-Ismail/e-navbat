    ...
    if (selectedIds.length === 0) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $('#suss_message').fadeIn().delay(1200).fadeOut();
                setTimeout(function() {
                    window.location.href = "{{ route('adminnavbattasdiq') }}";
                }, 4000);
            },
            error: function(xhr, status, error) {
                // Handle error
...
<!-- /.form-group -->
    ...
    <div class="card-header">
        <h3 class="card-title">Qabulga Tasdiqlanganlar Va Xizmat Ko`rsatish</h3>
    </div>
        ...
        <table id="example1" class="table table-bordered table-striped">
            <thead>
                <tr>
                    ...
                    <th>Buyurtmachi Telefon Nomeri</th>
                    <th>Qabulga Yozilishidan Maqsad</th>
                    <th>Qabul Vaqti</th>
                    <th>Qabul Sanasi</th>
                </tr>
            </thead>
    ...
    <button style="float: left; margin-right: 1%; width: 200px;" type="button" id="submit1" class="btn btn-primary" onclick="xizmatSelectedItems()">Xizmat Ko`rsatildi</button>
    <button style="float: right; margin-right: 1%; width: 200px;" type="button" id="submit2" class="btn btn-danger" onclick="deleteSelectedItems()">O`chirish</button>
</div>
