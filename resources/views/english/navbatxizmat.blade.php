...
<script>
    ...
    return false;
            ...
            if (add == 0)
            {
                $('#suss_message').html("<center><h5 style='color:#ffffff;'>Neter!</h5></center>");
    ...
    if (selectedIds.length === 0) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $('#suss_message').fadeIn().delay(1200).fadeOut();
                setTimeout(function() {
                    window.location.href = "{{ route('adminnavbatxizmateng') }}";
                }, 4000);
            },
            error: function(xhr, status, error) {
                // Handle error
...
<!-- /.form-group -->
    ...
    <div class="card-header">
        <h3 class="card-title">View Served Appointments</h3>
    </div>
    ...
    <button style="float: left; margin-right: 1%; width: 200px;" type="button" id="submit2" class="btn btn-danger" onclick="deleteSelectedItems()">Delete</button>
</div>
