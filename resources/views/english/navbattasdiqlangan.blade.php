                ...
                success: function(response) {
                    try {
                        ...
                        window.setTimeout(function() {
                            window.location.href = "{{ route('vaqteng') }}";
                        }, 4000);
                    } catch (e) {
    ...
    if (selectedIds.length === 0) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $('#suss_message').fadeIn().delay(1200).fadeOut();
                setTimeout(function() {
                    window.location.href = "{{ route('adminnavbattasdiqeng') }}";
                }, 4000);
            },
            error: function(xhr, status, error) {
                // Handle error
...
<!-- /.form-group -->
    ...
    <div class="card-header">
        <h3 class="card-title">View Confirmed Appointments</h3>
    </div>
        ...
        <table id="example1" class="table table-bordered table-striped">
            <thead>
                <tr>
                    ...
                    <th>Name of the appointee</th>
                    <th>Phone number of the appointee</th>
                    <th>Goal of the appointment</th>
    ...
    <button style="float: left; margin-right: 1%; width: 200px;" type="button" id="submit1" class="btn btn-primary" onclick="xizmatSelectedItems()">Served</button>
    <button style="float: right; margin-right: 1%; width: 200px;" type="button" id="submit2" class="btn btn-danger" onclick="deleteSelectedItems()">Delete</button>
</div>
