...
<div class="card card-default">
          <div class="card-header">
            <h3 class="card-title">Enter Appointment Time</h3>
          </div>
        ...
        <div id="suss_message2" class="ajax_Message" style="display: none"></div>
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-6">
              <form class="form-horizontal" action="{{ route('vaqteng') }} " name="material" id="material" method="post">
              @csrf <!-- CSRF token -->
...
<!-- /.form-group -->
<div class="form-group">
    <label>Duration for one apppointment</label>
 ...
 <!-- /.col -->
    ...
    <!-- /.card-body -->
    <button style="float: right; margin-right: 1%; width: 200px" type="button" id="submit" class="btn btn-danger" onclick="deleteSelectedItems()">Delete</button>
